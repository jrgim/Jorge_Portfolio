...
from Jorge_Portfolio.components.sidebar import sidebar
        ...
        rx.menu.root(
            ...
            rx.menu.content(
                *[
                ...
                menu_item_link("Contact", "/contact"),
            ),
        ),
        position="fixed",
        right="2em",
    ...
    def decorator(page_content: Callable[[], rx.Component]) -> rx.Component:
        ...
        def templated_page():
            return rx.hstack(
                ...
                menu_button(),
                align="start",
                background=f"radial-gradient(circle at top right, {rx.color('accent', 2)}, {rx.color('sage', 1)});",
                position="relative",
            )
